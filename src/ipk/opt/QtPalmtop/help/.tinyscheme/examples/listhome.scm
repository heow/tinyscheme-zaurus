...
;;; This simple program lists the directory
;;; entries on the user's home directory.

;;; It uses the following TinyScheme
;;; Extension functions:
;;;   getenv
;;;     Used to get HOME environment
;;;     variable.
;;;   open-dir-stream
...
;;;   close-dir-entry
;;;     Used at the end, to close 
;;;     directory stream when done.
...
(display "Listing contents of ")
(display homedir) (newline)
...
(usleep 4000000) ; hold display open
